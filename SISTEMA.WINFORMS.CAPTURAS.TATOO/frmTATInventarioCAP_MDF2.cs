    ...
    public partial class frmTATInventarioCAP_MDF2 : Form
    {
        ...
        private void CrearDT()
        {
            ...
            else
            {
                ...
                daux.Columns.Add("idCitaInventario", typeof(int));
                daux.Columns.Add("idInventario", typeof(int));
                daux.Columns.Add("Cantidad", typeof(int));
                daux.Columns.Add("ELIMINADO", typeof(bool));
            }
        }
        #endregion
        ...
        #region LOAD
        private void frmTATInventarioCAP_MDF2_Load(object sender, EventArgs e)
        {
            CrearDT();
            EnableButton();
            FillComboInventario();
